...
public interface IWorld
{
    ...
    IEnumerable<int> GetEntities<T1>() where T1 : struct, IComponent;
    ...
    /// <returns>An enumerable of entity IDs.</returns>
    IEnumerable<int> GetEntities<T1, T2>() where T1 : struct, IComponent where T2 : struct, IComponent;
    ...
    /// <returns>An enumerable of entity IDs.</returns>
    IEnumerable<int> GetEntities<T1, T2, T3>() where T1 : struct, IComponent where T2 : struct, IComponent where T3 : struct, IComponent;
    ...
    /// <returns>An enumerable of entity IDs.</returns>
    IEnumerable<int> GetEntities<T1, T2, T3, T4>() where T1 : struct, IComponent where T2 : struct, IComponent where T3 : struct, IComponent where T4 : struct, IComponent;
    ...
    /// <returns>An enumerable of entity IDs.</returns>
    IEnumerable<int> GetEntities<T1, T2, T3, T4, T5>() where T1 : struct, IComponent where T2 : struct, IComponent where T3 : struct, IComponent where T4 : struct, IComponent where T5 : struct, IComponent;
    ...
    /// <returns>An enumerable of entity IDs.</returns>
    IEnumerable<int> GetEntities<T1, T2, T3, T4, T5, T6>() where T1 : struct, IComponent where T2 : struct, IComponent where T3 : struct, IComponent where T4 : struct, IComponent where T5 : struct, IComponent where T6 : struct, IComponent;
    ...
    /// <returns>An enumerable of entity IDs.</returns>
    IEnumerable<int> GetEntities<T1, T2, T3, T4, T5, T6, T7>() where T1 : struct, IComponent where T2 : struct, IComponent where T3 : struct, IComponent where T4 : struct, IComponent where T5 : struct, IComponent where T6 : struct, IComponent where T7 : struct, IComponent;
    ...
    /// <returns>An enumerable of entity IDs.</returns>
    IEnumerable<int> GetEntities<T1, T2, T3, T4, T5, T6, T7, T8>() where T1 : struct, IComponent where T2 : struct, IComponent where T3 : struct, IComponent where T4 : struct, IComponent where T5 : struct, IComponent where T6 : struct, IComponent where T7 : struct, IComponent where T8 : struct, IComponent;
    ...
    /// <returns>An enumerable of entity IDs.</returns>
    IEnumerable<int> GetEntities<T1, T2, T3, T4, T5, T6, T7, T8, T9>() where T1 : struct, IComponent where T2 : struct, IComponent where T3 : struct, IComponent where T4 : struct, IComponent where T5 : struct, IComponent where T6 : struct, IComponent where T7 : struct, IComponent where T8 : struct, IComponent where T9 : struct, IComponent;
    ...
    /// <returns>An enumerable of entity IDs.</returns>
    IEnumerable<int> GetEntities<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>() where T1 : struct, IComponent where T2 : struct, IComponent where T3 : struct, IComponent where T4 : struct, IComponent where T5 : struct, IComponent where T6 : struct, IComponent where T7 : struct, IComponent where T8 : struct, IComponent where T9 : struct, IComponent where T10 : struct, IComponent;
    ...
    Bit256 RegisterComponent<T>() where T : struct, IComponent;
    ...
    void AddComponent<T>(int entityId, T component) where T : struct, IComponent;
    ...
    void UpdateComponent<T>(int entityId, T component) where T : struct, IComponent;
    ...
    T GetComponent<T>(int entityId) where T : struct, IComponent;
    ...
    /// <exception cref="EntityNotFoundException">Thrown if the entity does not exist.</exception>
    Bit256 GetSignature(int entityId);
}
